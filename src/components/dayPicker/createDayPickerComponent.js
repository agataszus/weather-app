...
export const createDayPickerComponent = (array) => {
  ...
  buttonLeft.setAttribute("data-id", array[3]);
  ...
  buttonRight.setAttribute("data-id", array[5]);
  ...
  // date tiles row
  const tilesRow = createDateTilesRowComponent(array);
